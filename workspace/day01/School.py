...
class Student:  #VO(Value Object) : 값들만을 관리하기 위한 용도의 클래스
...
while True :
    ...
    if choice == 1:
        ...
        #정보들이므로 학생 객체 내부의 stuscore 리스트에 append 해준다
        ...
        for i in range(len(stuList)):
            if(stuclass == stuList[i].stuclass):
                if(stunum == stuList[i].stunum):
